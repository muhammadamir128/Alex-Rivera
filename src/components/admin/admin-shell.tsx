  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex items-center gap-2.5 border-b border-white/5 px-5 py-4">
        ...
        <div>
          <div className="font-display text-sm font-semibold">{admin?.name || "Muhammad Amir"}</div>
      ...
      <div className="px-3 pt-3 pb-1">
        <Link
          href="/"
          onClick={onNavigate}
          className="group flex w-full items-center gap-2.5 rounded-xl border border-white/10 bg-white/[0.03] px-3.5 py-2 text-xs font-semibold text-foreground/90 transition-all hover:border-blue-500/40 hover:bg-white/[0.08] hover:text-white hover:shadow-lg hover:shadow-blue-500/10"
        >
          <ArrowLeft className="h-3.5 w-3.5 text-blue-400 transition-transform group-hover:-translate-x-1" />
          <span>Back to Home</span>
          <Home className="ml-auto h-3.5 w-3.5 text-muted-foreground/60 transition-colors group-hover:text-blue-400" />
        </Link>
      </div>
